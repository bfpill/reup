...
<div className="flex flex-row w-full h-40 gap-5 mb-64 mt-10">
  <div className="flex flex-row w-full h-40">
    ![CA](/images/daily-notes/CA.gif)
  </div>
  <div className="flex flex-row w-full h-40">
    ![CA](/images/daily-notes/CA_a.png)
  </div>
  <div className="flex flex-row w-full h-40">
    ![CA](/images/daily-notes/faces.gif)
  </div>
</div>
...
<div className="flex flex-row w-full h-40 mb-64 mt-10">
  ![CA](/images/daily-notes/glider.jpg)
</div>
...
<div className="flex flex-row w-full h-40 mb-64 mt-10">
  ![CA](/images/daily-notes/w&bCAtransformer2024-11-04.png)
</div>
...
<div className="flex flex-row w-full h-40 mb-64 mt-10">
  ![CA](/images/daily-notes/256_embed_2l_input_vs_prediction_pairs.png)
</div>
...
10:27 - no comment
<div className="flex flex-row w-full h-40 mb-64 mt-10">
  ![CA](/images/daily-notes/amogus.png)
</div>
...
<div className="flex flex-row w-full h-40 mb-64 mt-10">
  ![CA](/images/daily-notes/w&blongerRunCATransformer.png)
</div>