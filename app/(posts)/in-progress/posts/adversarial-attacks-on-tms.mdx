...
---
*This is a compendium of recent self guided work into robustness, complexity, and unlearning. The post starts with older work on refining the robustness/superposition correlation posited in Toy Models Of Superposition. Towards the end, I detail a novel method of detecting memorization in large models, and I detail my current (ambitious) work into new, constructionist methods we can use to discover circuits.*
