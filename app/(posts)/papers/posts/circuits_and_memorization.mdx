...
We present a __potential explanation__ for why we seem to be seeing different things at different temperatures, and what this might mean. Let's start with a couple of intuition bumps:
...
<img
  ...
  alt="LLC vs Sparsity Comparison"
  className="block w-full max-w-full mt-[70px] mb-[70px] md:w-[200%] md:ml-[-32%] md:max-w-none"
/>
