...
In practice, this means that temperature __controls the 'efficiency' of circuits that SGLD is allowed to noise out__. When the temperature is high, SGLD can only move in directions that harm low efficiency circuits. 
