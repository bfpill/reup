...
<img
  ...
  alt="LLC vs Sparsity Comparison"
  style={{ display: 'block', width: '170%', marginLeft: '-28%', maxWidth: 'none', marginTop: '70px', marginBottom: '70px'}}
/>
...
<img
  ...
  alt="LLC vs Sparsity Comparison"
  style={{ display: 'block', width: '170%', marginLeft: '-22.5%', maxWidth: 'none', marginTop: '70px', marginBottom: '70px'}}
/>
